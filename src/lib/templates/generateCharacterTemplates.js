...
const CENTER = 50;
const RIGHT = 80;
function createTemplate(char, category, displayName, strokes) {
...
function generateLine(x1, y1, x2, y2, steps = 4) {
    const guidePoints = [];
...
function generateCurve(startX, startY, endX, endY, controlX, controlY) {
    const steps = 6;
    const guidePoints = [];
    for (let i = 0; i <= steps; i++) {
        const t = i / steps;
...
function generateArc(centerX, centerY, radius, startAngle, endAngle) {
...
const numbers = [
    ...
    createTemplate('8', 'number', 'Eight', [
        ...
        generateCurve(CENTER, MIDDLE + 10, CENTER, BOTTOM - 10, CENTER + 30, BOTTOM - 20),
        generateCurve(CENTER, BOTTOM - 10, CENTER, MIDDLE + 10, CENTER - 30, BOTTOM - 20),
    ]),
...
const lowercase = [
    createTemplate('a', 'lowercase', 'a', [
        generateCurve(CENTER, MIDDLE - 10, CENTER, MIDDLE - 10, CENTER + 25, MIDDLE - 20),
        generateCurve(CENTER, MIDDLE - 10, CENTER, MIDDLE - 10, CENTER - 25, MIDDLE - 20),
    ...
    createTemplate('j', 'lowercase', 'j', [
        ...
        generateCurve(CENTER + 5, BOTTOM + 10, LEFT + 5, BOTTOM + 10, CENTER, BOTTOM + 25),
    ]),
