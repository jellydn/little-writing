 ...
 */
function pointToPathDistance(point, guidePath) {
 ...
 */
export function validateStroke(userPoints, guidePath) {
    // Handle edge cases
 ...
 */
export function calculateAverageDeviation(userPoints, guidePath) {
 ...
 */
export function findWorstDeviationPoint(userPoints, guidePath) {
    if (userPoints.length === 0 || guidePath.guidePoints.length === 0) {
        return null;
    }
    let maxDistance = 0;
